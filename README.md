...
O conteúdo desse guia segue uma sequência lógica de aprendizado progressivo. Cada aula aborda no mínimo um assunto em específico do R (a depender do assunto). Portanto, a não ser que haja domínio prévio dos temas eu aconselho a seguir essa estrutura, mas fique a vontade para utilizar da forma que quiser e explora-lo da maneira que achar ter mais sentido para si.  
